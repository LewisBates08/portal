...
Stage = Literal['Identified', 'Shortlisted', 'Interviewing', 'Offered', 'Hired', 'Rejected']
...
class Input(BaseModel):
    ...
    def trim_text(cls, value, info):
        return value.strip() if isinstance(value, str) and info.field_name not in ('password', 'token', 'refresh_token') else value
